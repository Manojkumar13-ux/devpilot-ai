...
export default function Register() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0f]">
      ...
      />
      <div className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-[#00d4ff] opacity-[0.06] blur-[120px]" />
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 rounded-full bg-[#6c63ff] opacity-[0.08] blur-[120px]" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-[#a0a0b8]">Start your interview practice journey</p>
        </div>

        <div className="glass-card p-8">
          <h2 className="text-xl font-semibold text-white mb-1">Create account</h2>
          <p className="text-sm text-[#6b6b85] mb-6">Join thousands of developers practicing with AI</p>
          ...
          <p className="mt-6 text-center text-sm text-[#6b6b85]">
            ...
            <Link to="/login" className="text-[#6c63ff] hover:text-[#8b83ff] font-medium transition-colors">
              Sign in
            </Link>
          </p>
        </div>
